...
public class PictureCompressUtil {
     ...
     * @throws IOException
     */
    public void compressByQuality(String imgPath, String outPath, int maxSize)
            throws IOException {
...
//      return compressByQuality(bitmap, 100,1000); // 这里再进行质量压缩的意义不大，反而耗资源，删除
     ...
     * @throws FileNotFoundException
     */
    public void compressBySampleSize(String imgPath, String outPath, float pixelW, float pixelH)
            throws FileNotFoundException {
